...
<body>
    ...
    <main>
        ...
        <form method="post" action="update_profile.php">
            <label for="description">Deskripsi Produk/Layanan:</label><br>
            <textarea id="description" name="description" rows="4" cols="50" required></textarea><br><br>
            <label for="contact">Kontak:</label><br>
            <input type="text" id="contact" name="contact" required><br><br>
            <label for="address">Alamat:</label><br>
            <input type="text" id="address" name="address" required><br><br>
            <label for="order_options">Opsi Pemesanan:</label><br>
            <input type="text" id="order_options" name="order_options" required><br><br>
